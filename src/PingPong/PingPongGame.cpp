...
PingPongGame::PingPongGame() {
    playerOne_ = new RacketComponent(-0.8, 0.1, Keys::W, Keys::S, *this);
    playerTwo_ = new RacketComponent(0.75, 0.1, Keys::Up, Keys::Down, *this);
